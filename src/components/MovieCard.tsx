...
// ✅ motion.div সরানো, layout prop সরানো, backdropFilter সরানো
const MovieCard: React.FC<MovieCardProps> = React.memo(({ movie, isFavorite, onToggleFavorite, onClick }) => {
